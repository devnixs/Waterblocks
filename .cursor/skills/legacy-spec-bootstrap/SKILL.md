...
The full instructions for this skill live in `.common-ai/skills/legacy-spec-bootstrap/SKILL.md`. Read that file now and follow its workflow. Do not act on this stub alone — the canonical file is the authoritative source.
